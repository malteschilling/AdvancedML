...
,HorizontalRule
,Header 1 ("",[],[("style","overflow: scroll; max-height: 400px;")]) [Str "What",Space,Str "is",Space,Str "a",Space,Str "Knowledge",Space,Str "Representation"]
...
,HorizontalRule
,Header 1 ("",[],[("style","overflow: scroll; max-height: 400px;")]) [Str "Example",Space,Str "for",Space,Str "PCA:",Space,Str "Python",Space,Str "Environment"]
,Div ("",["box"],[])
...
,HorizontalRule
,Header 1 ("",["sub"],[]) [Str "Application",Space,Str "of",Space,Str "Kernel",Space,Str "2"]
,Div ("",["col30"],[])
...
,HorizontalRule
,Header 1 ("",[],[("style","overflow: scroll; max-height: 400px;")]) [Str "Example:",Space,Str "SVM",Space,Str "Face",Space,Str "Detection"]
,Div ("",["box"],[])
...
,HorizontalRule
,Header 1 ("",["sub"],[("style","overflow: scroll; max-height: 400px;")]) [Str "RELOAD",Space,Str "Python",Space,Str "Environment"]
,Div ("",["box"],[])
 [Header 2 ("",[],[]) [Str "Initialize",Space,Str "and",Space,Str "load",Space,Str "python",Space,Str "environment."]
...
,Div ("",["biblio"],[])
 [Para [Str "Following",Space,Cite [Citation {citationId = "hinton2013esn", citationPrefix = [], citationSuffix = [], citationMode = NormalCitation, citationNoteNum = 0, citationHash = 16}] [Str "(Hinton",Space,Str "2013)"],Space,Str "in",Space,Str "his",Space,Str "Advanced",Space,Str "Machine",Space,Str "Learning",Space,Str "Course."]]
,HorizontalRule
...
,Div ("",["col70"],[])
 ...
 ,Div ("",["biblio"],[])
  [Para [Cite [Citation {citationId = "jaeger2007esn", citationPrefix = [], citationSuffix = [], citationMode = NormalCitation, citationNoteNum = 0, citationHash = 17}] [Str "(Jaeger",Space,Str "2007)"]]]]
,HorizontalRule
,Header 1 ("",["sub"],[]) [Str "Echo",Space,Str "State",Space,Str "Network",Space,Str "Example",Space,Str "Results"]
,Para [RawInline (Format "html") "<img data-src=\"data/02/esn_frequency.png\" style=\"height:auto;width:1200px;\">"]
...
,HorizontalRule
,Header 1 ("",["sub"],[("style","overflow: scroll; max-height: 400px;")]) [Str "Echo",Space,Str "State",Space,Str "Network",Space,Str "Example"]
,Div ("",["box"],[])
 [Header 2 ("",[],[]) [Str "Initialize,",Space,Str "load",Space,Str "python",Space,Str "environment."]
 ,CodeBlock ("",["python"],[("data-executable","true"),("data-language","python")]) "import numpy as np\nfrom pyESN.pyESN import ESN\nfrom matplotlib import pyplot as plt\n%matplotlib inline\n\ndata = np.load('pyESN/mackey_glass_t17.npy') #  http://minds.jacobs-university.de/mantas/code"]
,Div ("",["box"],[])
 [Header 2 ("",[],[]) [Str "Training",Space,Str "the",Space,Str "echo",Space,Str "state",Space,Str "network",Space,Str "and",Space,Str "showing",Space,Str "test",Space,Str "results",Space,Str "(use",Space,Str "larger",Space,Str "net",Space,Str "=",Space,Str "500",Space,Str "for",Space,Str "good",Space,Str "results)."]
 ,CodeBlock ("",["python"],[("data-executable","true"),("data-language","python")]) "esn = ESN(n_inputs = 1,\n          n_outputs = 1,\n          n_reservoir = 100,\n          spectral_radius = 1.5,\n          random_state=42)\n\ntrainlen = 500\nfuture = 500\npred_training = esn.fit(np.ones(trainlen),data[:trainlen])\n\nprediction = esn.predict(np.ones(future))\nprint(\"test error: \\n\"+str(np.sqrt(np.mean((prediction.flatten() - data[trainlen:trainlen+future])**2))))\n\nplt.figure(figsize=(11,1.5))\nplt.plot(range(0,trainlen+future),data[0:trainlen+future],'k',label=\"target system\")\nplt.plot(range(trainlen,trainlen+future),prediction,'r', label=\"free running ESN\")\nlo,hi = plt.ylim()\nplt.plot([trainlen,trainlen],[lo+np.spacing(1),hi-np.spacing(1)],'k:')\nplt.legend(loc=(0.61,1.1),fontsize='x-small')"
 ,Para [Str "The",Space,Str "results",Space,Str "show",Space,Str "first",Space,Str "part",Space,Str "and",Space,Str "then",Space,Str "the",Space,Str "prediction",Space,Str "in",Space,Str "the",Space,Str "future",Space,Str "without",Space,Str "further",Space,Str "input."]
 ,Div ("",["biblio"],[])
  [Para [Str "Example",Space,Str "code",Space,Str "from",Space,Str "[https://github.com/cknd/pyESN]."]]]
,HorizontalRule
